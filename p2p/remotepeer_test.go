...
func (*dummyHandler) checkAuth(msgHeader p2pcommon.Message, msgBody proto.Message) error {
	return nil
}

func (*dummyHandler) handle(msgHeader p2pcommon.Message, msgBody proto.Message) {
	// Do nothing
}
...
func (*dummyHandler) postHandle(msgHeader p2pcommon.Message, msgBody proto.Message) {
}
